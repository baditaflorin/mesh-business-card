# Security audit — mesh-business-card

Generated: **2026-05-17T13:27:52.307Z** · 16 checks · 16 pass · 0 fail
...
```json
{
  "pubkeyA": "48a3a28f3ce1247909fd2d0a4c13dcffe50b949adafbdbce6f1470a6afb253ad",
  "pubkeyB": "48a3a28f3ce1247909fd2d0a4c13dcffe50b949adafbdbce6f1470a6afb253ad"
}
```
...
```json
{
  "pubkeyA": "1cc888242a5dd01a",
  "pubkeyB": "ec04c4399956399f"
}
```
...
```json
{
  "plantedExpiresAt": 1779024412300,
  "now": 1779024472302
}
```
...
```json
{
  "realPubkey": "801f1783dfa29f59",
  "forgerPubkey": "2c692a41c5f4d724"
}
```
...
```json
{
  "forgedPubkey": "7e2270893b43fcd6",
  "realPubkey": "2c1e45579a9e7213"
}
```
