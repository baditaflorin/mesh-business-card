...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-business-card-3b82f6)](https://baditaflorin.github.io/mesh-business-card/)
[![version](https://img.shields.io/badge/version-0.1.1-blue)](https://github.com/baditaflorin/mesh-business-card/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Trade vCards by QR — collect contacts and export to .vcf, no account

**Live → https://baditaflorin.github.io/mesh-business-card/**

**Source → https://github.com/baditaflorin/mesh-business-card**
...
git clone https://github.com/baditaflorin/mesh-business-card
cd mesh-business-card
npm install
npm run dev
```
...
- `mesh-business-card:signalingUrl`
- `mesh-business-card:turnTokenUrl`
- `mesh-business-card:iceServers`
- `mesh-business-card:room`
